...
train_datagen = ImageDataGenerator(rescale=1./255)
training_set = train_datagen.flow_from_directory(r'C:\Users\Bhanu Srinija\Lung-Cancer-Detection-CT-Scan-Project-3-\Data\train',
                                                target_size=(224, 224),
                                                batch_size=32,
                                                class_mode='categorical')

test_set = train_datagen.flow_from_directory(r'C:\Users\Bhanu Srinija\Lung-Cancer-Detection-CT-Scan-Project-3-\Data\test',
                                                target_size=(224, 224),
                                                batch_size=32,
                                                class_mode='categorical')
...
im=image.load_img(r"C:\Users\Bhanu Srinija\Lung-Cancer-Detection-CT-Scan-Project-3-\Data\test\adenocarcinoma\000113 (7).png",target_size=(224,224))
predict_image(im)
